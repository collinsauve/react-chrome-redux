...
var Store = function () {
  ...
  function Store(_ref) {
    ...
    this.port = _webextensionPolyfill2.default.runtime.connect(this.extensionId, { name: portName });
    this.listeners = [];
    this.state = state;
  ...
  _createClass(Store, [{
    ...
    value: function dispatch(data) {
      ...
      return new Promise(function (resolve, reject) {
        _webextensionPolyfill2.default.runtime.sendMessage(_this3.extensionId, {
